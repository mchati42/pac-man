...
> **Note:** A graphical library is considered **similar to MLX** if each function you use has an equivalent in the MLX library. If a function you rely on has no MLX equivalent, it is not allowed.
