...
- [II. AI Instructions](#chapter-ii---ai-instructions)
- [III. Common Instructions](#chapter-iii---common-instructions)
...
- [V. Detailed specifications](#chapter-v---detailed-specifications)
  - [V.1 Usage](#v1-usage)
...
- [VI. Game specifications](#chapter-vi---game-specifications)
...
- [VII. Project packaging](#chapter-vii---project-packaging)
- [VIII. Project management](#chapter-viii---project-management)
- [IX. Readme Requirements](#chapter-ix---readme-requirements)
- [X. Submission and peer-review](#chapter-x---submission-and-peer-review)
...
In this project, you will create a complete and playable Pac-Man game in Python, using object-oriented programming, a simple graphical library (MLX or similar), and a modular, reusable architecture.

> **Important:** A graphical library is considered similar to MLX if each function you use has an equivalent in the MLX library. If a function you rely on has no MLX equivalent, it is not allowed.
...
# Chapter V - Detailed specifications
...
- It must take exactly one argument: a configuration file. The filename does not matter, but the file must be a JSON file.
...
> **Warning:** The game configuration will be updated during the defense.
...
# Chapter VI - Game specifications
...
During this project, you must use a structured approach to drive the project and provide evidence. You are free to use any approach and tools you may need to support your project management. You must produce various documents that prove your approach.
...
# Chapter X - Submission and peer-review
